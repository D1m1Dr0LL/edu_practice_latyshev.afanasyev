...
<img width="742" height="568" alt="изображение" src="https://github.com/user-attachments/assets/3ad63fe0-087f-4b92-ba70-9e7be6246dc6" />
...
<img width="1507" height="681" alt="image" src="https://github.com/user-attachments/assets/34db6319-f3e7-4dd4-8a3d-aefa02bee5f0" />
...
<img width="891" height="532" alt="изображение" src="https://github.com/user-attachments/assets/4827d36e-ead9-4c6c-ba06-61d682b1f13a" />
...
<img width="1401" height="674" alt="image" src="https://github.com/user-attachments/assets/5675ad6a-4018-489b-978a-570b861b2a93" />

*Проверка звонка 1*

<img width="1305" height="675" alt="image" src="https://github.com/user-attachments/assets/6b9b1fd8-db51-46d8-b472-2fd83e176ca4" />
...
<img width="627" height="638" alt="изображение" src="https://github.com/user-attachments/assets/fdb2b3e9-d02c-4caa-86ec-3e4d0c96ca56" />
...
*Проверка с 101 на 103*

# Лабораторная работа №7. Построение сети IP-телефонии между удаленными маршрутизаторами в среде Cisco Packet Tracer

## Шаг 1.

<img width="902" height="532" alt="изображение" src="https://github.com/user-attachments/assets/eba5f23e-5b7b-43c6-bee3-165d6a39669b" />
...
*Настройка интерфейса F0/0 на RouterA*
...
*Настройка интерфейса S0/3/0 на RouterA*
...
*Настройка DHCP-сервера на RouterA*
...
*Настройка CallManager Express на RouterA*
...
*Создание телефонных номеров на RouterA*
...
*Настройка итерфейсов на SwitchA*
...
*Проверка звонка внутри одной сети*
...
*Настройка имени и портов на SwitchB*
...
*Проверка звонка внутри второй сети*
...
*Проверка звонка между двумя сетями*
...
<img width="660" height="532" alt="изображение" src="https://github.com/user-attachments/assets/f3a7a12b-b17c-43be-892f-3b67e8864dce" />
...
*Назначение имени и настройка S0/1/0 на CMERouter*
...
*Включение f0/0 и настройка подынтерфейсво на CMERouter*
...
*Настройка CMESwitch, настройка транка к роутеру*
...
*Настройка интерфейсов телефонов*
...
*Назначение имени RemoteRouter и настройка s0/1/0*
...
*Включение f0/0 и настройка подынтерфейсов на RemoteRouter*
...
*Назначние имени RemoteSwitch и настройка f0/1 на trunk*
...
*Создание VLAN 30,40 и настройка f0/2 на RemoteSwitch*
...
*Проверка пинга между роутерами*
